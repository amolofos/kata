...
class LRUCacheBruteForceTest {

	private final static Logger LOGGER = LoggerFactory.getLogger(LRUCacheBruteForceTest.class);
	
	@Test
	@DisplayName("Simple test 1")
	void LRUCacheBruteForceTest1(TestInfo testInfo) {
		LOGGER.debug("Simple test 1");

		LRUCache solution = new LRUCacheBruteForce(2);
		solution.put(1, 1);
		solution.put(2, 2);
	...
	void LRUCacheBruteForceTest2(TestInfo testInfo) {
