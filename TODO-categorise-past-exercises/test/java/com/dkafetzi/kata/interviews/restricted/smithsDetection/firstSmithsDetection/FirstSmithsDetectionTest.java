package com.dkafetzi.kata.interviews.restricted.smithsDetection.firstSmithsDetection;
...
class FirstSmithsDetectionTest {
	...
	void testSimple(TestInfo testInfo) {
		String path_base = "hackerrank/firstSmithsDetection/testFiles/";
		...
		for (int i = 0; i < testCases.size(); i++) {
			try {
				...
				watch.reset();
				watch.start();
				output = String.valueOf(FirstSmithsDetection.arrange(input));
				watch.stop();
