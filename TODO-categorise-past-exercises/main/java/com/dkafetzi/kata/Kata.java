...
import com.dkafetzi.kata.hackerrank.fraudulentActivityNotifications.FraudulentActivityNotifications;
...
public class Kata implements CommandLineRunner {
	...
	@Autowired
	private FraudulentActivityNotifications fraudulentActivityNotifications;
    ...
    public void run(String... args) throws Exception {
		...
		switch (testName) {
			case "FraudulentActivityNotifications":
				//int notifications = fraudulentActivityNotifications.activityNotifications(input);
				//LOGGER.info("Result: We calculated {} notifications being generated.", notifications);
				break;
			default:
				LOGGER.info("Test is not supported...");
				break;
		}
    }
